...
from model.byol.BYOL_scratch import BYOL
...
def training(config):
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='train_neg_cos_sim_epoch',
        dirpath=config.dir_path,
        filename='byol-ResNet50',
        mode='min',
        save_top_k=1
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name_transform", default="VerticalFlip, GaussianBlur, Shuffle2D", type=str,
    ...
    parser.add_argument("--dir_path", default="C:/Users/nguyenva/Documents/simclr-stage", type=str,
                        help="dir checkpoint")
    ...
    Task.init(project_name="examples-internal",
              task_name="BYOL_"+args.__getattribute__("dataset")+"_solo_learn")
